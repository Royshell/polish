...
<template>
  <SectionCard
    ...
    <div class="border-t border-[#111128]">
      <RetroToggle
    ...
    <div class="relative p-1.5">
      <span
        class="absolute -top-1.5 right-2.5 text-base text-polish-yellow [text-shadow:0_0_8px_var(--color-polish-yellow)] pointer-events-none z-10 animate-[sparkle_1.5s_ease-in-out_infinite]">
        +✦
      </span>
      ...
      <button
        ...
        <span
          class="absolute top-0 -left-full w-3/5 h-full pointer-events-none [background:linear-gradient(90deg,transparent,rgba(255,255,255,0.2),transparent)] animate-[shine_3.75s_ease-in-out_infinite]" />
        <span

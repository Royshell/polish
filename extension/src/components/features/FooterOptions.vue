...
<template>
  <footer class="mt-auto border-t border-polish-border px-2.5 py-2 flex-shrink-0">
    ...
    >
      <div
        class="w-[14px] h-[14px] border flex items-center justify-center text-[9px] flex-shrink-0 transition-all"
        :class="autoApply
    ...
    >
      <svg viewBox="0 0 12 12" width="12" height="12" fill="currentColor" class="flex-shrink-0">
